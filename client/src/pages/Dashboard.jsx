...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (!storedUser && !hasBackend) { navigate('/login'); return }
  ...
  return (
    <div className={styles.layout}>
      ...
      <main className={styles.main}>
        ...
        {tab === 'bids' && (
          <div className={styles.content}>
            {displayBids.length === 0 ? <div className={styles.emptyState}>
        ...
        {tab === 'orders' && (
          <div className={styles.content}>
            {displayOrders.length === 0 ? <div className={styles.emptyState}>
                <span className={styles.emptyIcon}>📋</span>
